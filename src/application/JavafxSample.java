...
public class JavafxSample extends Application { 
   ...
   public void start(Stage stage) { 
	   ...
	   String test = keyInput.nextLine();
	   System.out.println(test);
	   */
	   //1600 by 1600 pixels for cd booklet
      ...
      //right2
      int monadGod = monadArchon - aeonOne[1];
      ...
      //right3
      int monadDemon = monadGod - aeonOne[2];
      ...
      //right4
      int monadAlpha = monadGod - aeonOne[3];
    ...
    //left5
      ...
      //right5
      int monadBeta = monadGod - aeonOne[4];
      ...
      //right6
      int monadRho = monadGod - aeonOne[5];
      ...
      //right7
      int monadSigma = monadGod - aeonOne[6];
    ...
    //left8
      ...
      //right8
      int monadXi = monadGod - aeonOne[7];
      ...
      //right9
      int monadUlimate = monadGod - aeonOne[8];
